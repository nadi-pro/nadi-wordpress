...
class Nadi_Admin
{
    ...
    public function enqueue_styles()
    {
         ...
         * class.
         */
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__).'css/nadi-admin.css', [], $this->version, 'all');
    ...
    public function enqueue_scripts()
    {
         ...
         * class.
         */
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__).'js/nadi-admin.js', ['jquery'], $this->version, false);
